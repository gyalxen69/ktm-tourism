...
const audioTracks = [
  {
    ...
    src: process.env.PUBLIC_URL + '/media/audios/temple-bells.mp3',
    duration: '1:30',
    type: 'Ambient',
  },
  {
    ...
    src: process.env.PUBLIC_URL + '/media/audios/thamel-sounds.mp3',
    duration: '0:30',
    type: 'City Sounds',
  },
  {
    ...
    src: process.env.PUBLIC_URL + '/media/audios/buddhist-chants.mp3',
    duration: '1:30',
    type: 'Mantra',
  },
];
